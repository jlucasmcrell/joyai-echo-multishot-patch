...
AUDITION_SCENE_DEFAULT = (
    ...
    "{dna} "
    "Looking into the lens, calm and personable, {name} rests both "
    "forearms on {pos} thighs so the hands come up into the bottom of "
    "frame, then partway through settles back, {pos} shoulders dropping "
